...
namespace detail {
template<typename T>
inline GLenum gl_attrib_type();
template<>
inline GLenum gl_attrib_type<float>(){
	return GL_FLOAT;
}
template<>
inline GLenum gl_attrib_type<int>(){
	return GL_INT;
}
template<>
inline GLenum gl_attrib_type<unsigned>(){
	return GL_UNSIGNED_INT;
}
template<>
inline GLenum gl_attrib_type<char>(){
	return GL_UNSIGNED_BYTE;
}
template<>
inline GLenum gl_attrib_type<glm::vec2>(){
	return gl_attrib_type<glm::vec2::value_type>();
}
template<>
inline GLenum gl_attrib_type<glm::vec3>(){
	return gl_attrib_type<glm::vec3::value_type>();
}
template<>
inline GLenum gl_attrib_type<glm::vec4>(){
	return gl_attrib_type<glm::vec4::value_type>();
}
template<>
inline GLenum gl_attrib_type<glm::mat4>(){
